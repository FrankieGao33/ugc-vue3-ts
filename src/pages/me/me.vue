		...
		<tabs :items="tabItems">
			<template #content="contentProps">
				<tabsPanel id="tabs-panel" :height="tabsPanelHeight" :list="contentProps.list"
					:tabType="contentProps.tabType" :column="3" />
			</template>
		</tabs>
	</view>
</template>
...
<script setup lang="ts">
	...
	backgroundImage.value = "https://ts1.cn.mm.bing.net/th/id/R-C.ddbe60882fb529b0252f393577ead646?rik=%2f7YBpw2SPJ9k0Q&riu=http%3a%2f%2fres.dps.cn%2fres%2fbgimg%2f16514%2f28.jpg&ehk=JVlxG8xOcZ7i%2boVLKEEBdrrRYjTNi%2fMaQKcqdHSRh0I%3d&risl=&pid=ImgRaw&r=0";
	userName.value = "阿斯旺";

	function calcTabsPanelHeight() {
		const windowHeight = uni.getWindowInfo()?.windowHeight || 0;

		uni.createSelectorQuery().select("#tabs-panel").boundingClientRect((data : UniApp.NodeInfo) => {
			const tabsTop = data?.top || 0;
			tabsPanelHeight.value = (windowHeight - tabsTop) || 300;
		}).exec();
	}
